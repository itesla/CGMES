...
public class FoafGraphsTest {
    ...
    public static void setUp() throws TripleStoreException {
        ...
        testerOnlyImplAllowingNestedGraphs = new TripleStoreTester(
                ...
                workingDir,
                input1, input2);
        testerOnlyBlazegraph = new TripleStoreTester(
                doAsserts,
                new String[] {TripleStoreFactory.IMPL_BLAZEGRAPH},
                base,
                workingDir,
                input1, input2);
        tester.load();
        testerOnlyImplAllowingNestedGraphs.load();
        testerOnlyBlazegraph.load();
    ...
    public void testLastNameOnlyIfNickFailsForBlazegraph() throws Exception {
        Expected expected = new Expected()
                ...
                .expect("graphPersons",
                        ...
                        "files:abc-nicks.ttl",
                        "files:abc-nicks.ttl");
        testerOnlyBlazegraph.testQuery(queries.get("lastNameOnlyIfNick"), expected);
    }

    private static TripleStoreTester tester;
    private static TripleStoreTester testerOnlyImplAllowingNestedGraphs;
    private static TripleStoreTester testerOnlyBlazegraph;
