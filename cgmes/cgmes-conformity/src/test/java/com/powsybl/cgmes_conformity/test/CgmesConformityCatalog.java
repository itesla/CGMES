 ...
 */
public class CgmesConformityCatalog {

    public final TestGridModel microBE() {
        return new TestGridModel(
                ENTSOE_CONFORMITY.resolve("CGMES_v2.4.15_MicroGridTestConfiguration_BC_BE_v2"),
                "",
                expectedMicroBE(),
                false,
                true);
    ...
    public final TestGridModel microNL() {
        return new TestGridModel(
                ENTSOE_CONFORMITY.resolve("CGMES_v2.4.15_MicroGridTestConfiguration_BC_NL_v2"),
                "",
                null,
                false,
                true);
    ...
    public final TestGridModel miniNodeBreaker() {
        return new TestGridModel(
                ENTSOE_CONFORMITY.resolve(
                        "CGMES_v2.4.15_MiniGridTestConfiguration_NodeBreaker_BaseCase_Complete_v3"),
                "",
    ...
    public final TestGridModel smallNodeBreaker() {
        return new TestGridModel(
                ENTSOE_CONFORMITY
                        .resolve("CGMES_v2.4.15_SmallGridTestConfiguration_NodeBreaker_v3.0.0"),
                "",
                null,
                true,
                true);
    ...
    public final TestGridModel real() {
        return new TestGridModel(
                ENTSOE_CONFORMITY.resolve("CGMES_v2.4.15_RealGridTestConfiguration_v2"),
                "",
                null,
                false,
                true);
